    ...
    <div className="min-h-screen p-6 animate-fade-in" style={{ backgroundColor: "#BEBEBE" }}>
      <div className="flex flex-col gap-6 w-full max-w-6xl mx-auto">
        <header className="flex items-center justify-between">
          <div>
            <h1 className="text-2xl font-bold text-primary tracking-tight">Catálogo do setor</h1>
            <p className="text-gray-700 text-sm">Monte sua solicitação adicionando itens ao pedido.</p>
          </div>
          <button
            onClick={() => setCartOpen(true)}
            className="bg-primary text-white px-5 py-2 rounded-full shadow-md hover:bg-[#1A3A3F] transition-all duration-200 ease-apple active:scale-95 font-medium flex items-center gap-2"
          >
